...
const categoriesData = [
    { name: "Electronics", subcategories: ["Mobile Phones & Accessories", "Laptops & Computers", "Tablets & E-readers", "Cameras & Photography", "Audio & Headphones", "Video Games & Consoles"] },
    { name: "Fashion", subcategories: ["Men's Clothing", "Women's Clothing", "Kids' Clothing", "Shoes & Footwear", "Accessories (e.g., bags, belts, hats)", "Jewelry & Watches"] },
    { name: "Home & Kitchen", subcategories: ["Furniture", "Home Decor", "Kitchen & Dining", "Bedding & Bath", "Appliances", "Cleaning Supplies"] },
    { name: "Health & Beauty", subcategories: ["Skincare", "Makeup & Cosmetics", "Haircare", "Personal Care & Hygiene", "Vitamins & Supplements", "Fragrances"] },
    { name: "Sports & Outdoors", subcategories: ["Exercise & Fitness", "Outdoor Recreation", "Sports Equipment", "Camping & Hiking", "Cycling", "Team Sports"] },
    { name: "Books & Media", subcategories: ["Books (e.g., Fiction, Non-fiction, Children's Books)", "eBooks & Audiobooks", "Movies & TV Shows", "Music (CDs, Vinyl, Digital)", "Magazines & Newspapers", "Educational Resources"] }
];
